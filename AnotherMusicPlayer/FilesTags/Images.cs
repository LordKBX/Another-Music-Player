                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        bitmap = (System.IO.File.Exists(folder + SeparatorChar + "Cover.jpg")) ? new BitmapImage(new Uri(folder + SeparatorChar + "Cover.jpg"))
                            : ((System.IO.File.Exists(folder + SeparatorChar + "Cover.png")) ? new BitmapImage(new Uri(folder + SeparatorChar + "Cover.png")) : BitmapMagic.BitmapToBitmapImage(Properties.Resources.album_large));
                    }
                    tags.Dispose();
                }
            }
