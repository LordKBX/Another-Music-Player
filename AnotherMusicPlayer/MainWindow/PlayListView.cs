...
namespace AnotherMusicPlayer
{
    public partial class MainWindow : Window
    {
        ...
        private void PlayListView_Init()
        {
            ...
            {
                if (PlayListView.ActualWidth > 500) { PlayListViewC5.Width = 60; }
            ...
            PlaylistsContentsC0.Width = 50;
            PlaylistsContentsC1.Width = PlaylistsContentsC2.Width = PlaylistsContentsC3.Width = PlaylistsContentsC4.Width = PlaylistsContentsC5.Width = 200;
            PlaylistsContents.SizeChanged += (sender, e) =>
            {
                Debug.WriteLine("PlaylistsContents.SizeChanged");
                PlaylistsContentsC1.Width = PlaylistsContentsC2.Width = PlaylistsContentsC3.Width =
                PlaylistsContentsC4.Width = PlaylistsContentsC5.Width = PlaylistsContents_CalcCollumnWidth();
            };
        }
        ...
        private double PlaylistsContents_CalcCollumnWidth() { double calc = (PlaylistsContents.ActualWidth - PlaylistsContentsC0.Width) / 5; return (calc > 0) ? calc : 0; }
